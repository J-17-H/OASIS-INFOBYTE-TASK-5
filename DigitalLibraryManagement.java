...
class DigitalLibraryManagement {
    ...
    public void admin_login() {
        ...
        loginto.put("Harika", 12345);
        loginto.put("Sai", 23456);
    ...
    public void user_login() {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("Keerthana", 22222);
        loginto.put("Divya", 20026);
        loginto.put("Soumya", 12345);
        loginto.put("Akshaya", 24680);
        loginto.put("Paru", 11111);
